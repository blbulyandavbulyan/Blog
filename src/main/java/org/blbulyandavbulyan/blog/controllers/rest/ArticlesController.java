...
public class ArticlesController {
     ...
     */
    @GetMapping("/info/all")
    public Page<ArticleInfoDTO> getInfoAboutAllArticles(@RequestParam(defaultValue = "5", name = "s") Integer pageSize, @RequestParam(defaultValue = "1", name = "p") Integer pageNumber) {
